...
function verifyToken(req, res, next) {
  // Get auth header value. When we send our token we want to send it in header
  // as auth value.
...
// If you run the express app from another directory, it’s safer to use the
...
// Here we use the cookie-parser middleware to parse incoming cookies off the
// req object and pass them to our cookieValidator function. The validateCookies
...
// This shows a middleware function mounted on the /user/:id path. The function
// is executed for any type of HTTP request on the /user/:id path.
